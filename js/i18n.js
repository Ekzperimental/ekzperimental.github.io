...
const translations = {
  ...
  bg: {
    ...
    "about.text1": "EKZPERIMENTAL е независимо студио, създадено от Костадин Екзаров. Студиото работи в областта на документалното, музикалното, комерсиалното и културното видео и си партнира с артисти, организации, фестивали и независими екипи в България и извън нея.",
    "about.text2": "С опит в режисурата, хореографията, визуалните изкуства и рекламата, Костадин съчетава разказ, монтаж и визуален дизайн, за да създава внимателно изградени филми с автентичен визуален език. Освен работата си по клиентски и независими проекти, той е основател на EKZPERIMENTAL и съосновател на JAM ON IT Festival и Flava House.",
